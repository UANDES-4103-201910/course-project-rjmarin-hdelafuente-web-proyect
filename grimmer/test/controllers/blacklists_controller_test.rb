...
class BlacklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blacklist" do
    assert_difference('Blacklist.count') do
      post blacklists_url, params: { blacklist: { ending_date: @blacklist.ending_date, start_date: @blacklist.start_date, user_id: @blacklist.user_id } }
    end
  ...
  test "should update blacklist" do
    patch blacklist_url(@blacklist), params: { blacklist: { ending_date: @blacklist.ending_date, start_date: @blacklist.start_date, user_id: @blacklist.user_id } }
