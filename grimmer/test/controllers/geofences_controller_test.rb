...
class GeofencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geofence" do
    assert_difference('Geofence.count') do
      post geofences_url, params: { geofence: { region: @geofence.region, user_id: @geofence.user_id } }
    end
  ...
  test "should update geofence" do
    patch geofence_url(@geofence), params: { geofence: { region: @geofence.region, user_id: @geofence.user_id } }
